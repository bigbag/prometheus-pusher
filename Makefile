...
dev/lint:
	...
	@exec isort .
	@echo "Run black"
	@exec black prometheus_pusher tests
	@echo "Run flake"
	@exec flake8 prometheus_pusher tests
	@echo "Run bandit"
	@exec bandit -r prometheus_pusher/*
	@echo "Run mypy"
	@exec mypy prometheus_pusher
...
dev/test:
	@echo "Run tests"
	PYTHONPATH=${PYTHONPATH} PYTHONASYNCIODEBUG=x py.test -svvv -rs --cov prometheus_pusher --cov-report term-missing -x
